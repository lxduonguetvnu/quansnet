...
function neworders(res, sql) {
    connection.query(sql, function (error, results) {
        ...
        //console.log(results[0]);
        res.render('food/neworders', { fooddrink: results[0] });
    });
}
...
function order(res,sql,results_fooddrink,results_customers) {
    connection.query(sql, function (error, results) {
          ...
          res.render('food/order', {order: results[0], fooddrink: results_fooddrink, customers: results_customers});
        });
}